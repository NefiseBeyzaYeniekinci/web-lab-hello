    ...
    return (
        <div className="bg-white dark:bg-gray-950 p-8 space-y-12">
            ...
            <section className="space-y-4">
                <h2 className="text-2xl font-semibold border-b pb-2 dark:text-gray-100 dark:border-gray-700">Buttons</h2>
                ...
                <div className="flex flex-wrap gap-3">
                    <Button variant="primary" disabled className="opacity-50 cursor-not-allowed pointer-events-none">Disabled</Button>
                </div>
            </section>

            {/* --- INPUTS --- */}
            <section className="space-y-4 max-w-md">
                <h2 className="text-2xl font-semibold border-b pb-2 dark:text-gray-100 dark:border-gray-700">Inputs</h2>
            ...
            {/* --- CARDS --- */}
            <section className="space-y-4">
                <h2 className="text-2xl font-semibold border-b pb-2 dark:text-gray-100 dark:border-gray-700">Cards</h2>
            ...
            <section className="space-y-4 max-w-xl">
                <h2 className="text-2xl font-semibold border-b pb-2 dark:text-gray-100 dark:border-gray-700">Alerts</h2>
